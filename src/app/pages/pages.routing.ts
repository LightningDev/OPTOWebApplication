...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'mobiledashboard', loadChildren: 'app/pages/mobiledashboard/mobiledashboard.module#MobileDashboardModule' },
      ...
      //{ path: 'materialsdetail', loadChildren: 'app/pages/materialsdetail/materialsdetail.module#MaterialsDetailModule' },
