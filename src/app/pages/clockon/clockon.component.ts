...
export class ClockOn implements AfterViewInit {
	...
	private status_emp:string="";
	private status_date:string="";
	private status_time:string="";
	private status_clock_on:string="";
	...
	private workcenters:any;
	private work_center_desc:any;
